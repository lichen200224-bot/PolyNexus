...
const launchUrl = 'https://chatgpt.com/'

function pageHasComposer() {
  return Boolean(document.querySelector('#prompt-textarea, textarea, [contenteditable="true"]'))
}

function pageFill(prompt) {
  const field = document.querySelector('#prompt-textarea, textarea, [contenteditable="true"]')
