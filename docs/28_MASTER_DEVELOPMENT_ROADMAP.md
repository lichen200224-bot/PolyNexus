...
### Current baseline snapshot — 2026-08-21
...
| WP-13 | Workflow hard gates, Evidence_Check, Human gate, verified verdict rules | OpenCode / Codex | 2 days | 2026-09-14 | `READY_FOR_CODEX_REVIEW` Attempt 9: 135 contract tests PASS, full Core 375 collected / 374 passed / 1 skipped, D11 Option C approve/reject fail-closed, reload validates actor_id/bound_task_id/bound_run_id/identity_hash/provenance_token via independent recomputation, persist uses dual-hash provenance for multi-field tamper detection; extended-key candidate detection prevents false positives; maturity: PARTIAL_INTEGRITY (full-consistent rewrite NOT detectable; D12 deferred to CP-04+); cross-task and same-task multi-run isolation verified; no new table/migration/endpoint/RunState/WorkMode/EvidenceType; CP-03 point allocation deferred until CP-03 completion |
