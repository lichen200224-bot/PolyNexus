...
| CP-02 | First Vertical Slice runnable path | 22% | 2026-09-06 | Project → ContextPackage → Task → Run execution → Finding/Evidence → Result → History, fresh DB repeat, actual exit codes | IN PROGRESS |
