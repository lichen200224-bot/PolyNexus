> 2026-09-10 Track A navigation override — CURRENT TRACK A: Architecture APPROVED / FROZEN，Gate2 PASS；Product HOLD，FORMAL_SYNC NOT YET EXECUTED，S0/W1–W6 NOT AUTHORIZED，real executor NOT VERIFIED，B01 NOT EXECUTED，Working Product NOT ACCEPTED。以下旧current/progress均保留歷史，不能作新派工授權。
>
...
## Current Operational State — 2026-09-01 (provenance reconciliation)

This block reconciles the primary checkout with the later isolated candidate.
It is authoritative for the current repository state; retained sections below
remain historical unless explicitly referenced here.

- **Primary lane:** branch `feature/first-vertical-slice`, HEAD
  `b87a0dc780e5d9a3bba083dbaf9552ca52508f9a`, upstream
  `backup/feature/first-vertical-slice`, working tree dirty, staged state empty.
- **Candidate lane:** isolated repository
  `C:\Users\hikar\.codex\visualizations\2026\08\30\01a058ba-4a09-75a1-b5ea-30b55cf91947\pn-g13-g14-acceptance-20260901`, branch
  `feature/first-vertical-slice`, HEAD
  `730912b5a3e19449c355975485f1fe77350a458a`, parent
  `af46ddfe032829b43f5b4ced43288c2104e96b36`, clean, ahead 22 of its
  `origin/feature/first-vertical-slice`. Its 22-commit range has now been
  fast-forward promoted to the approved backup remote.
- Candidate `origin` resolves to the local Temp repository
  `C:\Users\hikar\AppData\Local\Temp\polynexus-g13-writer-20260831`; it is
  not a GitHub or other approved external remote. Promotion target was the
  primary configured approved backup repository
  `D:\GitBackup\PolyNexus_Backup.git`, branch
  `feature/first-vertical-slice`; push exit code was `0`.
- Candidate documents report: `G13–G18 COMPLETE`, `CP04 WP17–WP20 COMPLETE`,
  `CP04 WP21 DEFERRED / UNVERIFIED`, `CP05 COMPLETE`, `CP06 WP28–WP32
  NONBROWSER COMPLETE`, and `CP06-RC PROVISIONALLY-ACCEPTED-WITH-LIMITATIONS`
  under Human decision `ACCEPT_RC_WITH_WP21_DEFERRED_UNVERIFIED`.
- Promotion evidence is now recorded in fresh clean clone
  `C:\Users\hikar\.codex\visualizations\2026\09\01\01a05d1b-755c-7d60-abeb-6f2c8aa57967\clean-clone-promotion-20260901`, exact HEAD
  `730912b5a3e19449c355975485f1fe77350a458a`, clean, with required project
  paths present. This is a checkpoint candidate pending formal Human acceptance.
- Candidate claims are now promotion-backed, but do **not** establish browser or
  vendor certification. WP21 remains `DEFERRED / UNVERIFIED`; CP06/RC remains
  provisional with limitations. Formal project progress remains **30/100 = 30%**
  until the promoted checkpoint receives the required Human acceptance.
- Candidate evidence is recorded in its own `docs/11_PROJECT_STATE.md` and
  `docs/12_HANDOFF_CURRENT.md`; the 22-commit range is present in the approved
  backup and clean-clone object database, but the primary checkout remains at
  `b87a0dc` and dirty. No merge or primary checkout mutation was performed.
- The promoted checkpoint contains the G15 redaction work; the primary checkout
  still shows legacy `reason=str(exc)` paths because it has not been merged.

### Routed closeout program — G19 through G23

The Human has routed the remaining work as a five-goal closeout program and has
delegated bounded intermediate decisions to Codex. This routing does not change
formal progress or convert provisional evidence into acceptance. The durable
prompts, authorization boundary, predecessor SHA gates, and completion contract
are in `docs/tasks/G19-G23-FIVE-GOAL-EXECUTION-ROUTING.md`.

| Goal | Current status | Dependency | Purpose |
|---|---|---|---|
| G19 | READY / NOT STARTED | promoted SHA `730912b5` | Canonical workspace and provenance consolidation |
| G20 | GATED / NOT STARTED | G19 exact output SHA | Reproducible Web dependency, test, and build gate |
| G21 | GATED / NOT STARTED | G20 PASS | Real-browser WP21 journey and failure-path evidence |
| G22 | GATED / NOT STARTED | G19 pre-audit; G20/G21 finalization | RC hardening, cross-machine proof, and G04 delivery closeout |
| G23 | GATED / NOT STARTED | G19–G22 terminal evidence | Final reconciliation and the Human's only planned acceptance decision |

Only G19 is dispatchable now. One active writer is allowed; G22 read-only
pre-audit is the only planned overlap with G20/G21. Formal project progress
remains **30/100** until G23 obtains an explicit Human acceptance decision.

### Completion status matrix

| Scope | Candidate lane | Primary lane | Formal progress earned | Completion note |
|---|---|---|---:|---|
| G13 Council binding | COMPLETE / promoted evidence | PROMOTED / HUMAN CHECKPOINT PENDING | 0% | Fresh clean-clone evidence passed |
| G14 cancellation/restart | COMPLETE / promoted evidence | PROMOTED / HUMAN CHECKPOINT PENDING | 0% | WP21/browser remains separate and unverified |
| G15 redaction | COMPLETE / promoted evidence | PROMOTED / HUMAN CHECKPOINT PENDING | 0% | Primary dirty checkout still has legacy path |
| G16 selection policy | COMPLETE / promoted evidence | PROMOTED / HUMAN CHECKPOINT PENDING | 0% | Fresh exact-SHA evidence passed |
| G17 migration/restore | COMPLETE / promoted evidence | PROMOTED / HUMAN CHECKPOINT PENDING | 0% | No real/user DB migration claimed |
| G18 Doctor freshness | COMPLETE / promoted evidence | PROMOTED / HUMAN CHECKPOINT PENDING | 0% | Fresh exact-SHA evidence passed |
| CP-04 | WP17–WP20 COMPLETE; WP21 DEFERRED / UNVERIFIED | PROMOTED / HUMAN CHECKPOINT PENDING | 0/18 points | No browser/vendor certification |
| CP-05 | COMPLETE | PROMOTED / HUMAN CHECKPOINT PENDING | 0/12 points | Fresh Core evidence passed |
| CP-06 / RC | WP28–WP32 NONBROWSER COMPLETE; RC PROVISIONAL | PROMOTED / HUMAN CHECKPOINT PENDING | 0/10 points | Human limitation: WP21 deferred/unverified |

Formal project progress therefore remains **30/100**. Candidate completion is
explicitly recorded for routing and provenance, but does not earn points until
remote identity, clean-clone, scope, fresh acceptance, and required Human
checkpoint gates are satisfied.

Date: 2026-08-28
Version: Development Baseline v1.0 + Dev Preparation Profile v1.0.2
Milestone: First Vertical Slice — WP-08A/WP-08B/WP-09B/WP-09C/WP-09D/WP-10/WP-12/WP-13 ACCEPTED; CP-02 complete; CP-03 in progress; PRE-WP14-A HUMAN_ACCEPTED / IMPLEMENTATION_ACCEPTED at `28196c9`; PRE-WP14-B HUMAN_ACCEPTED / IMPLEMENTATION_ACCEPTED at `c615733`; G05 Registry remediation HUMAN_ACCEPTED / CROSS_MACHINE_CONTINUATION_READY at product checkpoint `aaee59c`, with final evidence-state checkpoint `78835f8`.
...
## Current Priority
1. Retain G05 Registry remediation as `HUMAN_ACCEPTED / CROSS_MACHINE_CONTINUATION_READY` at product checkpoint `backup/g05-runtime-registry-exception-fix@aaee59c96f0aa5cca3ea81e0afd16dc49955ebd1`; final evidence/acceptance-state checkpoint is `backup/g05-runtime-registry-exception-fix@78835f85ae0a8890d9cca3a67daf5c3145f02749`, with implementation, review, remote and clean-clone gates complete.
2. Preserve the excluded pre-existing dirty files (`docs/15_DOCUMENT_INDEX.md`, `docs/tasks/WP-12.md`) and all G03/WP-14/WP-16 ownership; do not absorb them into G05.
3. Retain WP-15 acceptance at `backup/wp15-opencode-runtime@05b263351662ce557e12f9cda4a89e7bd4f02aa9`; G04 remains `DEFERRED / DO_NOT_START`, and broader production/runtime or Browser E2E gates remain separate.
...
G05 Registry remediation is `IMPLEMENTED / REVIEW_PASS / REMOTE_CHECKPOINT_VERIFIED / CLEAN_CLONE_VERIFIED / CANONICAL_SCOPE_ACCEPTED / HUMAN_ACCEPTED / CROSS_MACHINE_CONTINUATION_READY` for the Registry component. The label is based on the explicit Human acceptance and option A canonical-scope decision; it does not establish whole-project cross-machine readiness while the main checkout remains dirty.
...
Phase: First Vertical Slice — CP-03 in progress; PRE-WP14-A accepted at `28196c9`; PRE-WP14-B Human-accepted / implementation-accepted; G05 Registry remediation is Human-accepted with component-level continuation readiness.
Next Phase: Route G06/WP-14/WP-16 only through their separate gates and explicit owner assignments. No production-runtime support claim is authorized by this state reconciliation.
...
Current Planned Task: Next explicitly routed runtime task after G05 closure; WP-14 and WP-16 remain separately gated
Active Writer: G05 `NONE / RELEASED`; existing foreign dirty ownership is preserved
Reviewer: Fresh independent Codex context; Writer != Reviewer is mandatory; current G05 implementation review is `PASS / NO BLOCKER`
...
## G05 Current State Reconciliation — 2026-08-28

- Registry remediation checkpoint: `backup/g05-runtime-registry-exception-fix@aaee59c96f0aa5cca3ea81e0afd16dc49955ebd1`; final G05 evidence/acceptance-state checkpoint is `backup/g05-runtime-registry-exception-fix@78835f85ae0a8890d9cca3a67daf5c3145f02749`. The isolated branch, remote ref and fresh final clean clone are clean and match.
- Exact G05 changed files are limited to `services/core/src/polynexus_core/runtime/registry.py`, `services/core/tests/test_runtime_registry_conformance.py`, and `docs/tasks/RUNTIME-ADAPTER-CONFORMANCE.md`.
- Fresh deterministic evidence: Registry targeted `36 passed`; PRE-WP14-A/B plus persistence `144 passed`; Core collect-only `515 collected`; Full Core `514 passed / 1 SKIPPED`; all exit code `0`. The single skip is the pre-existing Windows symlink-policy test at `services/core/tests/test_wp07_integration.py:799`.
- Baseline validator passed in the G05 clean clone; governance, static secret/vendor/fail-closed checks, exact allowlist and `git diff --check` passed. The earlier controlled-runtime launcher failure and non-fatal pytest atexit `PermissionError [WinError 5]` remain recorded as environment evidence, not product PASS.
- WP-15 remains accepted at `backup/wp15-opencode-runtime@05b263351662ce557e12f9cda4a89e7bd4f02aa9`; product content is unchanged, targeted tests returned `30 passed`, exit `0`, and its existing `HUMAN_ACCEPTED / CROSS_MACHINE_CONTINUATION_READY` state is retained.
- Human selected canonical-scope option A. Current canonical checkpoint is `backup/runtime-adapters-integration@8dc9f5ccfb157e384b8f2a2199aa4e92eb93216b`; it contains the G05 commit as a merge parent, its clean clone is verified, and combined Registry plus WP-15 compatibility returned `66 passed`, exit `0`.
- G05 status is `IMPLEMENTED / REVIEW_PASS / REMOTE_CHECKPOINT_VERIFIED / CLEAN_CLONE_VERIFIED / CANONICAL_SCOPE_ACCEPTED / HUMAN_ACCEPTED / CROSS_MACHINE_CONTINUATION_READY` for the Registry component. Project-wide `CROSS_MACHINE_CONTINUATION_READY` remains unclaimed because the main checkout retains unrelated dirty paths.
- Architecture impact: `NONE`; ADR-001～ADR-011, RuntimeAdapter Protocol, Domain, Persistence, API, migrations and public behavior remain unchanged except intended fail-closed handling of hostile profile input. Real OpenCode CLI/network/credentials/production registry/API/export/logging/usage metering remain unverified.
