...
checkpoint is `4fd73b5ac3b59ae1f948f8d95ad795112552b1b2`; its clean clone is
verified at the recorded path. The subsequent docs-only state-sync is pushed
to the approved ref. No remote reconfiguration, secret handling, or G27 start
is permitted.
